...
// Vérifier si le lien d'inscription est déjà utilisé
        if ($resultat_verif_inscription == 1) {
            echo '<br><div align="center"><span class = "message">Le lien pour l\'inscription est déjà expiré!!!</span></div><br>';

// Afficher le message après avoir validé le formulaire d'inscription    
        } elseif ($message == "oui") {
            echo '<div align="center"><span class = "message">Votre inscription est bien enregistrée. Un email de validation a été envoyé à votre adresse mail. Veuillez valider votre inscription avec le lien fourni dans ce mail.</span></div>';
        } else {

// Vérifier s'il y a email dans le lien pour l'inscription
            if ($email == null) {
                echo '<div align = "center"><span class = "message">Cet espace est réservée aux étudiants CCI Tours de la promotion actuelle. Si vous êtes un ancien étudiant et vous êtes intéressé par cette page, veuillez contacter m2ccitours@gmail.com pour plus d\'informations</span></div>';
            } elseif ($guid == null) {
                echo '<div align = "center"><span class = "message">Veuillez vous inscrire avec le lien fourni dans le mail envoyé</span></div>';
            } else {
...
// ajouter les infos d'utilisateur dans la BD
            ...
            // Afficher le message après avoir validé le formulaire d'inscription   
            redirect(get_query_var('pagename') . "/?message=oui");
        }
    }
}
